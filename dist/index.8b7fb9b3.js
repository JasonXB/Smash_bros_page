...
},{"core-js/stable":"95FYz","regenerator-runtime/runtime":"1EBPE","./clickEvents.js":"TW1yO","./hoverEvents.js":"dbfQE","./animatedZoom.js":"2Mkey","./mobileSliderEvents":"7amdc"}],"95FYz":[function(require,module,exports) {
...
parcelHelpers.export(exports, "clickEvents", ()=>clickEvents
);
...
},{}],"dbfQE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const allHoverEvents = function() {
    ...
    const hardwarenav_anchors = Array.from(document.querySelectorAll(".nav__sublink--lineup, .nav__sublink--accessories, .nav__sublink--amiibo"));
...
},{"medium-zoom":"lu5oF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lu5oF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
/* eslint-disable-next-line no-prototype-builtins */ var isNodeList = function isNodeList(selector) {
...
var mediumZoom1 = function mediumZoom(selector) {
   ...
   */ var Promise = window.Promise || function Promise(fn) {
    ...
    var update = function update() {
        ...
        if (options.container && options.container instanceof Object) newOptions.container = _extends({
        }, zoomOptions.container, options.container);
        if (options.template) {
    ...
    var open = function open() {
        ...
        return new Promise(function(resolve) {
            ...
            var _handleOpenEnd1 = function _handleOpenEnd() {
                isAnimating = false;
            ...
            active.zoomed.addEventListener('transitionend', _handleOpenEnd1);
    ...
    var close = function close() {
        return new Promise(function(resolve) {
            ...
            var _handleCloseEnd1 = function _handleCloseEnd() {
            ...
            active.zoomed.addEventListener('transitionend', _handleCloseEnd1);
        });
    };
...
var css1 = ".medium-zoom-overlay{position:fixed;top:0;right:0;bottom:0;left:0;opacity:0;transition:opacity .3s;will-change:opacity}.medium-zoom--opened .medium-zoom-overlay{cursor:pointer;cursor:zoom-out;opacity:1}.medium-zoom-image{cursor:pointer;cursor:zoom-in;transition:transform .3s cubic-bezier(.2,0,.2,1)!important}.medium-zoom-image--hidden{visibility:hidden}.medium-zoom-image--opened{position:relative;cursor:pointer;cursor:zoom-out;will-change:transform}";
styleInject(css1);
exports.default = mediumZoom1;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"7amdc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const mobileSliderEvents = function() {
    ...
    const hardwareTab = document.querySelector(".mobileSlider .nav__link--hardware");
    ...
    const focusableElements = Array.from(document.querySelectorAll(".mobileSlider .nav__link:not(.nav__link--games, .nav__link--hardware)") // all elements that highlight red on hover aside from gamesTab and hardwareTab
    );
    //@ ——————————————————————————————————————————————————————
    // Utility functions
    ...
    const resetGamesTab = function() {
        ...
        gamesNav.classList.remove("open"); // closes the gamenav extension
        // Set hardware arrow down
        const arrowSVG = document.querySelector(".mobileSlider .nav__link--games > svg:last-of-type");
        const svgParent = arrowSVG.closest(".nav__link");
        arrowSVG.remove();
        svgParent.insertAdjacentHTML("beforeend", downString);
    };
    const resetHardwareTab = function() {
        ...
        hardwareNav.classList.remove("open"); // closes the hardwarenav extension
        // Set hardware arrow down
        const arrowSVG = document.querySelector(".mobileSlider .nav__link--hardware > svg:last-of-type");
        const svgParent = arrowSVG.closest(".nav__link");
        arrowSVG.remove();
        svgParent.insertAdjacentHTML("beforeend", downString);
    };
